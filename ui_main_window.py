...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.titlebar_layout.setContentsMargins(10, 5, 6, 5)
        ...
        self.min_btn.setMinimumSize(QSize(34, 28))
        self.min_btn.setMaximumSize(QSize(34, 28))

        self.titlebar_layout.addWidget(self.min_btn)

        self.max_btn = QPushButton(self.titlebar)
        self.max_btn.setObjectName(u"max_btn")
        self.max_btn.setMinimumSize(QSize(34, 28))
        self.max_btn.setMaximumSize(QSize(34, 28))

        self.titlebar_layout.addWidget(self.max_btn)

        self.close_btn = QPushButton(self.titlebar)
        self.close_btn.setObjectName(u"close_btn")
        self.close_btn.setMinimumSize(QSize(34, 28))
        self.close_btn.setMaximumSize(QSize(34, 28))
